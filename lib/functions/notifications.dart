...
var androiInit = const AndroidInitializationSettings('@mipmap/launcher_icon'); //for logo
...
Future<void> _showGeneralNotification(message) async {
  ...
  fltNotification.initialize(initSetting,
      onDidReceiveNotificationResponse: notificationTapBackground,
      onDidReceiveBackgroundNotificationResponse: notificationTapBackground);
  await fltNotification.show(id++, message['title'], message['message'], notificationDetails);
  id = id++;
}
