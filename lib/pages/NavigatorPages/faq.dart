...
//get faq datas
  ...
  faqDatas() async {
    var val = await getFaqData(centerPosition!.latitude, centerPosition!.longitude);
    if (val == 'logout') {
      navigateLogout();
    }
    if (mounted) {
                                              ...
                                              ? InkWell(
                                                  onTap: () async {
                                                    ...
                                                    val = await getFaqPages(
                                                        '${centerPosition!.latitude}/${centerPosition!.longitude}?page=${myFaqPage['pagination']['current_page'] + 1}');
                                                    if (val == 'logout') {
                                                      navigateLogout();
                                                    }
                                                    setState(() {
