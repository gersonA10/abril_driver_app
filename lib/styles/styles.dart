...
Color buttonColor = const Color(0xffDBD121A);
Color newRedColor = const Color.fromARGB(255, 184, 1, 1);
Color trazoColor = const Color.fromRGBO(230, 54, 54, 1);
Color theme = const Color(0xffDBD121A);
...
Color loaderColor = const Color(0xffDBD121A);
...
Color onlineDriver = const Color(0xffDBD121A);
Color borderLines = const Color(0xffE5E5E5);
Color starColor = const Color(0xffDBD121A);
